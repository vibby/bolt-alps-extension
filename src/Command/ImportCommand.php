        ...
        foreach ($pages as $page) {
            ...
            if ($type == 'planning') {
                ...
                $record->setValues([
                    ...
                    'sabbath_school_presidency' => isset($page['Catéchèse Présidence']) ? $page['Catéchèse Présidence'] : null,
                    ...
                    'presidency' => isset($page['Estrade']) ? $page['Estrade'] : null,
                    ...
                    'sound_booth' => isset($page['Sonorisation']) ? $page['Sonorisation'] : null,
